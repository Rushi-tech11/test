...
const Dashboard = () => {
  ...
  return (
    <div className={WRAPPER}>
      ...
      <div className={HEADER}>
        <div className="min-w-0">
          <h1 className="text-xl md:text-3xl font-bold text-gray-800 flex items-center gap-2">
            <HomeIcon className="text-purple-500 w-3 h-5 md:w-6 md:h-6 shrink-0" />
      ...
      className='hidden md:flex items-center justify-center p-4 border-2 dashed border-purple-200
      rounded hover:border-purple-400 bg-puprle-50/50 cursosr-pointer transition-colors'>
      ...
      {/* Change the TaskModel call to this */}
{showModal && (
  <TaskModel 
    isOpen={showModal}
    onClose={() => {
    ...
    taskoEdit={selectedTask}
    onSave={handleTaskSave}
    onLogout={() => {/* handle logout if needed */}}
  />
)}
    </div>
  );
