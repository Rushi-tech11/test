...
const Login = ({ onSubmit, onSwitchMode }) => {
  ...
  return (
    <div className="max-w-md bg-white w-100 shadow-lg border border-purple-100 rounded-xl p-8">
      ...
      <button 
  type="button"
  className="text-purple-600 hover:text-purple-700 hover:underline font-medium transition-color"
  onClick={handleSwitchMode}  // Fixed: onclick -> onClick
>
  Sign up
</button>
      </p>
