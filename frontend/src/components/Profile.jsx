...
import { ChevronLeft, Frown, LogOut, Save, Shield, UserCircle ,Lock} from "lucide-react";
...
return (
    ...
    <div className="max-w-4xl mx-auto p-6">
        ...
        <div>
            ...
            <p className="text-gray-500 text-sm">Mange your profile and security and Settings</p>
        ...
        <div className="grid md:grid-cols-2 gap=8">
            <section className={SECTION_WRAPPER}>
                <div className="flex items-center gap-2 mb-6">
                    <UserCircle className="text-purle-500 w-5 h-5"/>
                    <h2 className="text-xl font-semibold text-gray-600">Personal Information</h2>
                ...
                <section className={SECTION_WRAPPER}>
                    <div className="flex items-center gap-2 mb-6">
                    <Shield className="text-purle-500 w-5 h-5"/>
                ...
                <form onSubmit={changePassword} className="space-y-4">
                    ...
                    <div className="mt-8 pt-6 border-t border-purple-100">
                        <h3 className="text-red-600 font-semibold mb-4 flex items-center gap-2">
                            <LogOut className="w-4 h-4"/>Denger Zone
                        </h3>
